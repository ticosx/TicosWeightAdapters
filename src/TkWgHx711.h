 ...
 */
class TkWgHx711: public WeightAdapter{

    public:
        TkWgHx711(weight_info *info);
    ...
    private:
        ...
        uint32_t offset_value = 0; // used for tare weight
        float    scale_value = 1; // used to return weight in grams, kg, ounces, whatever
